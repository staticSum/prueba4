...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Consultar datos del Alumno</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="row mb-2">
                <div class="col-12">
                    <form action="consultarAlumno" method="POST">
                        ...
                        <div class="input-group">
                            <input type="search" class="form-control" placeholder="No. de Boleta" name="buscador2" value="<?php if ($alumno && $es === true) {
                                                                                                                                echo $alumno["Id_Alumno"];
                ...
                // $es = siEsNumeroDeBoleta(@$_POST["buscador2"]);
                // if (isset($_POST["buscador2"]) && $es === true) {
